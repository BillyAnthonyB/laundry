...
<section id='signup'>
    ...
    <form>
        <div class = "box-login">
            ...
            <div class="mb-3 row">
                <label for="exampleInputEmail3"  class="col-sm-2 col-form-label" >No. Hp</label>
                <div class="col-sm-10">
                <input type="email" class="form-control" id="exampleInputEmail3" aria-describedby="emailHelp" placeholder="">
                </div>
            </div>
            <div class="mb-3 row">
